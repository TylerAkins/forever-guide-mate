...
ns:RegisterGuide({
    ...
    goals = {
        ...
        },
        {
            ...
            useClientPin = true,
            text = "Stonesplinter Trogg Disguise: Stonesplinter Trogg Disguise. No saved spot for this, so the guide follows the pin in your quest log.",
        ...
        },
        {
            ...
            useClientPin = true,
            text = "Turn in Stonesplinter Trogg Disguise. No saved spot for this, so the guide follows the pin in your quest log.",
