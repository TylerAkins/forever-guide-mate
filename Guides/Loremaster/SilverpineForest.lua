...
-- Silverpine Forest Loremaster route.
...
-- Leveling route: Guides/Leveling/12-20-silverpine-forest.lua
-- Quest list: https://www.wowhead.com/forever/quests/eastern-kingdoms/silverpine-forest
...
ns:RegisterGuide({
    ...
    goals = {
        ...
        },
        {
            ...
            text = "Accept Wild Eyes from Quinn Yorick.",
            complete = QuestState(91920, "activeOrCompleted"),
            route = {
                Point(MAP.SILVERPINE, 0.534, 0.126, "Quinn Yorick",
                    "Travel to Quinn Yorick."),
            },
        },
        {
            id = "objective-91920-wild-eyes-1",
            kind = "objective",
            priority = 410,
            conditions = {
                all = {
            ...
            complete = QuestObjective(91920, 1, "Murloc Eye"),
            route = {
                Point(MAP.SILVERPINE, 0.598, 0.154, "Vile Fin Shredder",
        ...
        },
        {
            ...
            dependsOn = { "objective-91920-wild-eyes-1" },
            complete = QuestState(91920, "completed"),
            route = {
                Point(MAP.SILVERPINE, 0.428, 0.408, "Apothecary Renferrel",
                    "Travel to Apothecary Renferrel."),
            },
        },
        {
            ...
            text = "Accept Return to Quinn (Again) from Apothecary Renferrel.",
        ...
        {
            id = "objective-91921-return-to-quinn-again-1",
            kind = "objective",
            priority = 440,
            conditions = {
                all = {
            ...
            complete = QuestObjective(91921, 1, "Quinn's Potion"),
            route = {
                Point(MAP.SILVERPINE, 0.428, 0.408, "Apothecary Renferrel",
                    "Travel to Apothecary Renferrel."),
            },
        },
        {
            ...
            dependsOn = { "objective-91921-return-to-quinn-again-1" },
        ...
        },
        {
            ...
            text = "Accept Watching the Roads from Shadow Priest Allister.",
            complete = QuestState(95981, "activeOrCompleted"),
            route = {
                Point(MAP.SILVERPINE, 0.440, 0.410, "Shadow Priest Allister",
                    "Travel to Shadow Priest Allister."),
            },
        },
        {
            id = "objective-95981-watching-the-roads-1",
            kind = "objective",
            priority = 730,
            conditions = {
                all = {
            ...
            complete = QuestObjective(95981, 1, "Dalaran Watcher"),
            route = {
                Point(MAP.SILVERPINE, 0.440, 0.410, "Shadow Priest Allister",
                    "Travel to Shadow Priest Allister."),
            },
        ...
        {
            id = "objective-95981-watching-the-roads-2",
            kind = "objective",
            priority = 740,
            conditions = {
                all = {
            ...
            dependsOn = { "accept-95981-watching-the-roads" },
            complete = QuestObjective(95981, 2, "Dalaran Wizard"),
            route = {
                Point(MAP.SILVERPINE, 0.440, 0.410, "Shadow Priest Allister",
                    "Travel to Shadow Priest Allister."),
            },
        },
        {
            ...
            dependsOn = { "objective-95981-watching-the-roads-2" },
        ...
        {
            id = "objective-98298-arugals-folly-1",
            kind = "objective",
            priority = 2140,
            conditions = {
                all = {
            ...
            complete = QuestObjective(98298, 1, "Worgen Bits"),
            route = {
                Point(MAP.SILVERPINE, 0.500, 0.740, "Moonrage Bloodhowler",
        ...
        },
        {
            ...
            dependsOn = { "objective-98298-arugals-folly-1" },
        ...
        {
            id = "objective-95884-the-offering-stone-1",
            kind = "objective",
            priority = 2390,
            conditions = {
                all = {
            ...
            complete = QuestObjective(95884, 1, "Note Scrap"),
            route = {
                Point(MAP.SILVERPINE, 0.590, 0.708, "Ravenclaw Guardian",
                    "Travel to Ravenclaw Guardian."),
            },
        },
        {
            id = "turnin-95884-the-offering-stone",
            kind = "turnin",
            priority = 2400,
            conditions = {
                all = {
            ...
            useClientPin = true,
            text = "Turn in The Offering Stone. No saved spot for this, so the guide follows the pin in your quest log.",
            dependsOn = { "objective-95884-the-offering-stone-1" },
            complete = QuestState(95884, "completed"),
            route = {},
        },
        {
            id = "objective-95883-the-tortured-soul-1",
            kind = "objective",
            priority = 2410,
            conditions = {
                all = {
            ...
            text = "The Tortured Soul: Tortured Soul.",
            complete = QuestObjective(95883, 1, "Tortured Soul"),
            route = {
                Point(MAP.SILVERPINE, 0.590, 0.708, "Ravenclaw Guardian",
                    "Travel to Ravenclaw Guardian."),
            },
        ...
        {
            id = "turnin-95883-the-tortured-soul",
            kind = "turnin",
            priority = 2420,
            conditions = {
                all = {
            ...
            useClientPin = true,
            text = "Turn in The Tortured Soul. No saved spot for this, so the guide follows the pin in your quest log.",
            dependsOn = { "objective-95883-the-tortured-soul-1" },
            complete = QuestState(95883, "completed"),
            route = {},
        },
        {
            id = "objective-95885-the-offering-of-blood-1",
            kind = "objective",
            priority = 2430,
            conditions = {
                all = {
            ...
            useClientPin = true,
            text = "The Offering of Blood: Tortured Soul. This is an elite. Bring a group. No saved spot for this, so the guide follows the pin in your quest log.",
            complete = QuestObjective(95885, 1, "Tortured Soul"),
            route = {},
        },
        {
            id = "turnin-95885-the-offering-of-blood",
            kind = "turnin",
            priority = 2440,
            conditions = {
                all = {
            ...
            useClientPin = true,
            text = "Turn in The Offering of Blood. No saved spot for this, so the guide follows the pin in your quest log.",
            dependsOn = { "objective-95885-the-offering-of-blood-1" },
            complete = QuestState(95885, "completed"),
            route = {},
        },
        {
        ...
        },
        {
            ...
            complete = QuestState(452, "activeOrCompleted"),
            route = {
                Point(MAP.SILVERPINE, 0.464, 0.742, "Deathstalker Faerleia",
                    "Travel to Deathstalker Faerleia."),
            },
        },
        {
            id = "objective-452-pyrewood-ambush-1",
            kind = "objective",
            priority = 2530,
            conditions = {
                all = {
            ...
            dependsOn = { "accept-452-pyrewood-ambush" },
            complete = QuestObjective(452, 1, "Pyrewood Ambush"),
            route = {
                Point(MAP.SILVERPINE, 0.464, 0.742, "Deathstalker Faerleia",
                    "Travel to Deathstalker Faerleia."),
            },
        },
        {
            ...
            dependsOn = { "objective-452-pyrewood-ambush-1" },
            complete = QuestState(452, "completed"),
            route = {
                Point(MAP.SILVERPINE, 0.464, 0.742, "Deathstalker Faerleia",
                    "Travel to Deathstalker Faerleia."),
            },
