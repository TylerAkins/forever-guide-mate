...
ns:RegisterGuide({
    ...
    goals = {
        ...
        },
        {
            ...
            route = {
                Point(MAP.BARRENS, 0.4674, 0.7963, "Continue toward Nak",
                    "Continue toward Nak."),
                Point(MAP.BARRENS, 0.4383, 0.8196, "Continue toward Nak",
                    "Continue toward Nak."),
        ...
        },
        {
            ...
            route = {
                Point(MAP.BARRENS, 0.4610, 0.7640, "Continue toward Gann's Reclamation",
        ...
        },
        {
            ...
            route = {
                Point(MAP.BARRENS, 0.4610, 0.7640, "Continue toward Revenge of Gann",
        ...
        },
        {
            ...
            route = {
                Point(MAP.BARRENS, 0.4600, 0.7500, "Continue toward Revenge of Gann",
                    "Continue toward Revenge of Gann."),
