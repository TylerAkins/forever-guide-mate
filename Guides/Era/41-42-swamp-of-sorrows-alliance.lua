...
ns:RegisterGuide({
    ...
    goals = {
        ...
        },
        {
            ...
            route = {
                Point(MAP.SWAMP_OF_SORROWS, 0.3490, 0.5317, "Continue toward Encroaching Wildlife",
                    "Continue toward Encroaching Wildlife."),
                Point(MAP.SWAMP_OF_SORROWS, 0.2860, 0.5224, "Continue toward Encroaching Wildlife",
                    "Continue toward Encroaching Wildlife."),
                Point(MAP.SWAMP_OF_SORROWS, 0.2641, 0.4598, "Continue toward Encroaching Wildlife",
                    "Continue toward Encroaching Wildlife."),
        ...
        },
        {
            ...
            route = {
                Point(MAP.SWAMP_OF_SORROWS, 0.8360, 0.1410, "Continue toward Driftwood",
                    "Continue toward Driftwood."),
                Point(MAP.SWAMP_OF_SORROWS, 0.9330, 0.3636, "Continue toward Driftwood",
                    "Continue toward Driftwood."),
                Point(MAP.SWAMP_OF_SORROWS, 0.9439, 0.4145, "Continue toward Driftwood",
                    "Continue toward Driftwood."),
                Point(MAP.SWAMP_OF_SORROWS, 0.9476, 0.4483, "Continue toward Driftwood",
                    "Continue toward Driftwood."),
                Point(MAP.SWAMP_OF_SORROWS, 0.9460, 0.4966, "Continue toward Driftwood",
                    "Continue toward Driftwood."),
