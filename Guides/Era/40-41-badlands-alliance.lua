...
ns:RegisterGuide({
    ...
    goals = {
        ...
        },
        {
            ...
            route = {
                Point(MAP.BADLANDS, 0.1100, 0.7200, "Continue toward Tremors of the Earth",
                    "Continue toward Tremors of the Earth."),
                Point(MAP.BADLANDS, 0.1800, 0.7970, "Continue toward Tremors of the Earth",
                    "Continue toward Tremors of the Earth."),
                Point(MAP.BADLANDS, 0.5900, 0.6900, "Continue toward Tremors of the Earth",
                    "Continue toward Tremors of the Earth."),
                Point(MAP.BADLANDS, 0.4800, 0.5100, "Continue toward Tremors of the Earth",
                    "Continue toward Tremors of the Earth."),
                Point(MAP.BADLANDS, 0.2950, 0.5900, "Continue toward Tremors of the Earth",
                    "Continue toward Tremors of the Earth."),
