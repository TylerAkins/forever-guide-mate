...
ns:RegisterGuide({
    ...
    goals = {
        ...
        },
        {
            ...
            route = {
                Point(MAP.ARATHI, 0.3157, 0.8205, "Continue toward Death From Below",
                    "Continue toward Death From Below."),
                Point(MAP.ARATHI, 0.3147, 0.8102, "Continue toward Death From Below",
                    "Continue toward Death From Below."),
        ...
        },
        {
            ...
            route = {
                Point(MAP.HINTERLANDS, 0.1352, 0.4476, "Continue toward Wildhammer Keep",
                    "Continue toward Wildhammer Keep."),
                Point(MAP.HINTERLANDS, 0.1346, 0.4397, "Continue toward Wildhammer Keep",
                    "Continue toward Wildhammer Keep."),
                Point(MAP.HINTERLANDS, 0.1346, 0.4166, "Continue toward Wildhammer Keep",
                    "Continue toward Wildhammer Keep."),
        ...
        },
        {
            ...
            route = {
                Point(MAP.HINTERLANDS, 0.7236, 0.6607, "Continue toward The Super Snapper FX",
                    "Continue toward The Super Snapper FX."),
                Point(MAP.HINTERLANDS, 0.7672, 0.6063, "Continue toward The Super Snapper FX",
                    "Continue toward The Super Snapper FX."),
