...
-- Alliance Era leveling route for Tanaris, levels 43-44.
...
ns:RegisterGuide({
    id = "leveling-era-43-44-tanaris",
    title = "43-44 Tanaris (Era)",
    ...
    goals = {
        ...
        },
        {
            ...
            kind = "accept",
            priority = 70,
            text = "Accept Water Pouch Bounty from Spigot Operator Luglunket in Gadgetzan.",
            complete = QuestState(1707, "activeOrCompleted"),
            route = {
                Point(MAP.TANARIS, 0.5246, 0.2843, "Spigot Operator Luglunket",
        ...
        },
        {
            ...
            kind = "accept",
            priority = 580,
            text = "Accept Handle With Care from Curgle Cranklehop in Gadgetzan.",
