...
-- Leveling route: Guides/Leveling/Era/12-20-silverpine-forest.lua
...
ns:RegisterGuide({
    ...
    goals = {
        ...
        },
        {
            ...
            text = "The Offering of Blood: Tortured Soul. Wowhead has no pin, so follow the quest text. This is an elite. Bring a group.",
