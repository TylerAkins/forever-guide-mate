...
-- Leveling route: Guides/Leveling/Era/1-12-dun-morogh.lua
-- Quest list: https://www.wowhead.com/forever/quests/eastern-kingdoms/dun-morogh
-- Dungeon quests stay in the dungeon guides.
-- Coordinates have not been validated in the Forever client.
-- Left out on purpose:
-- Underground Map (96391) stays in the dungeon guides.
-- The Treaty of Understanding (98423) stays in the dungeon guides.
-- Welcome! (5841) is unused or not offered.
...
ns:RegisterGuide({
    ...
    goals = {
        ...
        {
            id = "accept-314-protecting-the-herd",
            kind = "accept",
            priority = 1270,
            conditions = {
                all = {
            ...
            complete = QuestState(314, "activeOrCompleted"),
            route = {
                Point(MAP.DUN_MOROGH, 0.630, 0.498, "Rudra Amberstill",
                    "Travel to Rudra Amberstill."),
            },
        },
        {
            id = "objective-314-protecting-the-herd-1",
            kind = "objective",
            priority = 1280,
            conditions = {
                all = {
            ...
            dependsOn = { "accept-314-protecting-the-herd" },
            complete = QuestObjective(314, 1, "Fang of Vagash"),
            route = {
                Point(MAP.DUN_MOROGH, 0.624, 0.462, "Vagash",
                    "Travel to Vagash."),
            },
        },
        {
            id = "turnin-314-protecting-the-herd",
            kind = "turnin",
            priority = 1290,
            conditions = {
                all = {
            ...
            dependsOn = { "objective-314-protecting-the-herd-1" },
            complete = QuestState(314, "completed"),
            route = {
                Point(MAP.DUN_MOROGH, 0.630, 0.498, "Rudra Amberstill",
                    "Travel to Rudra Amberstill."),
            },
        ...
        },
        {
            ...
            route = {
                Point(MAP.DUN_MOROGH, 0.476, 0.526, "Jarven Thunderbrew",
                    "Travel to Jarven Thunderbrew."),
            },
        },
        {
            id = "objective-308-distracting-jarven-1",
            kind = "objective",
            priority = 2140,
            conditions = {
                all = {
            ...
            text = "Distracting Jarven: Thunder Ale.",
            dependsOn = { "accept-308-distracting-jarven" },
            complete = QuestObjective(308, 1, "Thunder Ale"),
            route = {
                Point(MAP.DUN_MOROGH, 0.476, 0.526, "Jarven Thunderbrew",
                    "Travel to Jarven Thunderbrew."),
            },
        ...
        {
            id = "turnin-308-distracting-jarven",
            kind = "turnin",
            priority = 2150,
            conditions = {
                all = {
            ...
            text = "Turn in Distracting Jarven to Jarven Thunderbrew.",
            dependsOn = { "objective-308-distracting-jarven-1" },
            complete = QuestState(308, "completed"),
            route = {
                Point(MAP.DUN_MOROGH, 0.476, 0.526, "Jarven Thunderbrew",
                    "Travel to Jarven Thunderbrew."),
            },
        ...
        {
            id = "accept-403-guarded-thunderbrew-barrel",
            kind = "accept",
            priority = 2160,
            conditions = {
                all = {
            ...
            text = "Accept Guarded Thunderbrew Barrel from Guarded Thunder Ale Barrel.",
            complete = QuestState(403, "activeOrCompleted"),
            route = {
                Point(MAP.DUN_MOROGH, 0.477, 0.527, "Guarded Thunder Ale Barrel",
                    "Travel to Guarded Thunder Ale Barrel."),
            },
        },
        {
            id = "objective-403-guarded-thunderbrew-barrel-1",
            kind = "objective",
            priority = 2170,
            conditions = {
                all = {
            ...
            text = "Guarded Thunderbrew Barrel: Guarded Thunderbrew Barrel.",
            dependsOn = { "accept-403-guarded-thunderbrew-barrel" },
            complete = QuestObjective(403, 1, "Guarded Thunderbrew Barrel"),
            route = {
                Point(MAP.DUN_MOROGH, 0.477, 0.527, "Guarded Thunder Ale Barrel",
                    "Travel to Guarded Thunder Ale Barrel."),
            },
        ...
        {
            id = "turnin-403-guarded-thunderbrew-barrel",
            kind = "turnin",
            priority = 2180,
            conditions = {
                all = {
            ...
            text = "Turn in Guarded Thunderbrew Barrel to Guarded Thunder Ale Barrel.",
            dependsOn = { "objective-403-guarded-thunderbrew-barrel-1" },
            complete = QuestState(403, "completed"),
            route = {
                Point(MAP.DUN_MOROGH, 0.477, 0.527, "Guarded Thunder Ale Barrel",
                    "Travel to Guarded Thunder Ale Barrel."),
            },
        },
        {
            ...
            complete = QuestState(95041, "activeOrCompleted"),
            route = {
                Point(MAP.IRONFORGE, 0.678, 0.438, "Jemma Quikswitch",
                    "Travel to Jemma Quikswitch in Ironforge."),
            },
        },
        {
            id = "objective-95041-data-hoarders-1",
            kind = "objective",
            priority = 2200,
            conditions = {
                all = {
            ...
            dependsOn = { "accept-95041-data-hoarders" },
            complete = QuestObjective(95041, 1, "Gnomeregan Archival Data"),
            route = {
                Point(MAP.IRONFORGE, 0.678, 0.438, "Jemma Quikswitch",
                    "Travel to Jemma Quikswitch in Ironforge."),
            },
        },
        {
            ...
            dependsOn = { "objective-95041-data-hoarders-1" },
            complete = QuestState(95041, "completed"),
            route = {
                Point(MAP.IRONFORGE, 0.678, 0.438, "Jemma Quikswitch",
                    "Travel to Jemma Quikswitch in Ironforge."),
            },
        ...
        {
            id = "accept-95217-the-quarrys-smith",
            kind = "accept",
            priority = 2220,
            conditions = {
                all = {
            ...
            complete = QuestState(95217, "activeOrCompleted"),
            route = {
                Point(MAP.DUN_MOROGH, 0.688, 0.558, "Frast Dokner",
                    "Travel to Frast Dokner."),
            },
        },
        {
            id = "objective-95217-the-quarrys-smith-1",
            kind = "objective",
            priority = 2230,
            conditions = {
                all = {
            ...
            dependsOn = { "accept-95217-the-quarrys-smith" },
            complete = QuestObjective(95217, 1, "Copper Bar"),
            route = {
                Point(MAP.DUN_MOROGH, 0.814, 0.530, "Scarred Crag Boar",
                    "Travel to Scarred Crag Boar."),
            },
        },
        {
            id = "objective-95217-the-quarrys-smith-2",
            kind = "objective",
            priority = 2240,
            conditions = {
                all = {
            ...
            dependsOn = { "accept-95217-the-quarrys-smith" },
            complete = QuestObjective(95217, 2, "Toughened Boar Hide"),
            route = {
                Point(MAP.DUN_MOROGH, 0.814, 0.530, "Scarred Crag Boar",
                    "Travel to Scarred Crag Boar."),
            },
        ...
        {
            id = "turnin-95217-the-quarrys-smith",
            kind = "turnin",
            priority = 2250,
            conditions = {
                all = {
            ...
            dependsOn = { "objective-95217-the-quarrys-smith-2" },
            complete = QuestState(95217, "completed"),
            route = {
                Point(MAP.DUN_MOROGH, 0.688, 0.558, "Frast Dokner",
                    "Travel to Frast Dokner."),
            },
        ...
        },
        {
            ...
            route = {
                Point(MAP.DUN_MOROGH, 0.648, 0.584, "Earthseer Farsen",
                    "Travel to Earthseer Farsen."),
            },
        },
        {
            id = "accept-96392-farsens-watch",
            kind = "accept",
            priority = 2280,
            conditions = {
                all = {
            ...
            text = "Accept Farsen's Watch from Earthseer Farsen.",
            complete = QuestState(96392, "activeOrCompleted"),
            route = {
                Point(MAP.DUN_MOROGH, 0.648, 0.584, "Earthseer Farsen",
                    "Travel to Earthseer Farsen."),
            },
        ...
        {
            id = "objective-96392-farsens-watch-1",
            kind = "objective",
            priority = 2290,
            conditions = {
                all = {
            ...
            dependsOn = { "accept-96392-farsens-watch" },
            complete = QuestObjective(96392, 1, "Use Farsen's Farsight"),
            route = {
                Point(MAP.DUN_MOROGH, 0.648, 0.584, "Earthseer Farsen",
                    "Travel to Earthseer Farsen."),
            },
        },
        {
            ...
            dependsOn = { "objective-96392-farsens-watch-1" },
            complete = QuestState(96392, "completed"),
            route = {
                Point(MAP.DUN_MOROGH, 0.648, 0.584, "Earthseer Farsen",
                    "Travel to Earthseer Farsen."),
            },
        ...
        {
            id = "accept-96390-nip-em-in-the-bud",
            kind = "accept",
            priority = 2310,
            conditions = {
                all = {
            ...
            text = "Accept Nip 'Em in the Bud from Earthseer Farsen.",
            complete = QuestState(96390, "activeOrCompleted"),
            route = {
                Point(MAP.DUN_MOROGH, 0.648, 0.584, "Earthseer Farsen",
                    "Travel to Earthseer Farsen."),
            },
        ...
        {
            id = "objective-96390-nip-em-in-the-bud-1",
            kind = "objective",
            priority = 2320,
            conditions = {
                all = {
            ...
            dependsOn = { "accept-96390-nip-em-in-the-bud" },
            complete = QuestObjective(96390, 1, "Dark Iron Spy"),
            route = {
                Point(MAP.DUN_MOROGH, 0.648, 0.584, "Earthseer Farsen",
                    "Travel to Earthseer Farsen."),
            },
        ...
        {
            id = "turnin-96390-nip-em-in-the-bud",
            kind = "turnin",
            priority = 2330,
            conditions = {
                all = {
            ...
            dependsOn = { "objective-96390-nip-em-in-the-bud-1" },
            complete = QuestState(96390, "completed"),
            route = {
                Point(MAP.DUN_MOROGH, 0.648, 0.584, "Earthseer Farsen",
                    "Travel to Earthseer Farsen."),
            },
        ...
        },
        {
            ...
            text = "Accept Search for Incendicite from Pilot Stonegear.",
            complete = QuestState(466, "activeOrCompleted"),
            route = {
        ...
        {
            id = "objective-466-search-for-incendicite-1",
            kind = "objective",
            priority = 2360,
            conditions = {
                all = {
            ...
            dependsOn = { "accept-466-search-for-incendicite" },
            complete = QuestObjective(466, 1, "Incendicite Ore"),
            route = {
                Point(MAP.DUN_MOROGH, 0.496, 0.484, "Pilot Stonegear",
                    "Travel to Pilot Stonegear."),
            },
        ...
        {
            id = "turnin-466-search-for-incendicite",
            kind = "turnin",
            priority = 2370,
            conditions = {
                all = {
            ...
            dependsOn = { "objective-466-search-for-incendicite-1" },
            complete = QuestState(466, "completed"),
            route = {
                Point(MAP.DUN_MOROGH, 0.496, 0.484, "Pilot Stonegear",
                    "Travel to Pilot Stonegear."),
            },
