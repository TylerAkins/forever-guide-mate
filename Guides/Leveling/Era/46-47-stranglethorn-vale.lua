...
ns:RegisterGuide({
    ...
    goals = {
        ...
        {
            id = "travel-610-southern-savage-coast",
            kind = "travel",
            priority = 70,
            conditions = {
                all = {
            ...
            route = {
                Point(MAP.STRANGLETHORN, 0.2963, 0.7236, "Continue toward Southern Savage Coast",
                    "Continue toward Southern Savage Coast."),
                Point(MAP.STRANGLETHORN, 0.2742, 0.6943, "Southern Savage Coast",
