...
ns:RegisterGuide({
    ...
    goals = {
        ...
        },
        {
            ...
            route = {
                Point(MAP.TANARIS, 0.5756, 0.4830, "Continue toward Tanaris Field Sampling",
                    "Continue toward Tanaris Field Sampling."),
                Point(MAP.TANARIS, 0.5321, 0.5126, "Continue toward Tanaris Field Sampling",
                    "Continue toward Tanaris Field Sampling."),
                Point(MAP.TANARIS, 0.5367, 0.5854, "Continue toward Tanaris Field Sampling",
                    "Continue toward Tanaris Field Sampling."),
                Point(MAP.TANARIS, 0.5933, 0.6069, "Continue toward Tanaris Field Sampling",
                    "Continue toward Tanaris Field Sampling."),
        ...
        {
            id = "travel-654-gadgetzan",
            kind = "travel",
            priority = 440,
            text = "Travel to Gadgetzan.",
            route = {
                Point(MAP.TANARIS, 0.5245, 0.2851, "Gadgetzan",
                    "Travel to Gadgetzan."),
            },
        },
        {
