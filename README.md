...
Forever GuideMate is a local-development guide addon for World of Warcraft: Forever. Version `0.1.0` contains the first engine framework and dungeon quest guides for Ragefire Chasm, Wailing Caverns, the Ruins of Lordaeron, the Deadmines, and the Hall of Thanes.
