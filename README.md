...
Forever GuideMate is a local-development guide addon for World of Warcraft: Forever. Version `0.1.0` contains the first engine framework, dungeon quest guides for Ragefire Chasm, Wailing Caverns, the Ruins of Lordaeron, the Deadmines, and the Hall of Thanes, the Skyborne starter guide for Zephras Isle, and Horde Loremaster guides for Durotar, Mulgore, and the Barrens. The Loremaster guides are for finishing a zone's quests. They can be followed while leveling, but that is not what they are written for. Zephras Isle is the leveling guide. The rules for adding the next zone are in [docs/zone-loremaster-guides.md](docs/zone-loremaster-guides.md).
