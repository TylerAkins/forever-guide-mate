...
Loremaster finishes the zone. The walk is the leveling route in `Guides/Era/`. A quest on the Wowhead Forever zone page that is not already on that route is woven in:
