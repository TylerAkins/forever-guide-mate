...
- Removed the "Continue toward" path pins. A step keeps its destination, then the guide moves on. If one of those pins is ever generated again, it is skipped when you are already closer to a later pin.
