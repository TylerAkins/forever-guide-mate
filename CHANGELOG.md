...
- A follow-up that only sends you to another NPC no longer stops on an accept step at the giver. Hidden Enemies, The Missing Shipment, Samophlange, and the Zephras delivery visits point at the next person.
